...
@section('description', __('blog.tag_label') . ' #' . $tagName)
...
{!! json_encode($schemaTagBreadcrumbs, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT) !!}
</script>
@endpush
    ...
    <div class="py-10 md:py-14">
        <div class="landing-container">
            ...
            <nav aria-label="Breadcrumb" class="mb-6 flex flex-wrap items-center gap-2 text-xs font-semibold text-muted">
                ...
                <span class="text-border-subtle" aria-hidden="true">/</span>
                <span class="text-body" aria-current="page">#{{ $tagName }}</span>
            </nav>
