        ...
        <div class="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
            ...
            @if ($aboutImg)
                <div class="lg:col-span-6 relative group">
                    <div class="relative mx-auto max-w-md lg:max-w-none">
                        ...
                        <div class="absolute -top-6 -left-6 -z-10 h-72 w-72 rounded-full bg-primary/20 blur-2xl group-hover:scale-110 transition-transform duration-700"></div>
                        <div class="absolute -bottom-6 -right-6 -z-10 h-72 w-72 rounded-full bg-accent/20 blur-2xl group-hover:scale-110 transition-transform duration-700"></div>
                        ...
                        {{-- Floating badge --}}
                        <div class="absolute bottom-6 left-6 rounded-2xl bg-surface-raised/95 dark:bg-zinc-900/95 backdrop-blur-md px-4 py-2.5 shadow-lg border border-border-subtle dark:border-zinc-800 flex items-center gap-2.5 hover:scale-105 hover:shadow-2xl transition-all duration-300 cursor-default">
                            <span class="flex h-7 w-7 items-center justify-center rounded-lg bg-linear-to-br from-primary/20 to-accent/20 text-primary">
            ...
            <div class="{{ $aboutImg ? 'lg:col-span-6' : 'lg:col-span-12 max-w-3xl mx-auto text-center' }}">
                @if (filled($aboutLabel))
                    <span class="inline-flex items-center gap-1 text-xs font-bold uppercase tracking-widest text-primary bg-linear-to-r from-primary/15 to-accent/15 px-3.5 py-1.5 rounded-full border border-primary/25 shadow-2xs hover:scale-105 hover:shadow-xs transition-all duration-300 cursor-default">
                        {{ $aboutLabel }}
                    </span>
                @endif
