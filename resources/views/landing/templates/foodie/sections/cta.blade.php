...
<section id="cta" class="scroll-mt-20 py-16 sm:py-24 bg-surface-base border-b border-border-subtle dark:border-zinc-800 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative overflow-hidden rounded-3xl bg-linear-to-br from-primary via-primary-dark to-accent px-6 py-12 sm:px-12 sm:py-16 text-center text-white shadow-2xl">
            ...
            <div class="relative z-10 max-w-2xl mx-auto">
                <span class="inline-flex items-center gap-1.5 rounded-full bg-white/20 backdrop-blur-md border border-white/30 px-3.5 py-1 text-xs font-bold text-white shadow-2xs">
                ...
                <div class="mt-8 flex flex-wrap items-center justify-center gap-3.5">
                    @if ($whatsappUrl)
                        <a
                            ...
                            class="inline-flex items-center gap-2 rounded-full bg-white text-zinc-900 px-7 py-3.5 text-sm font-bold shadow-lg hover:bg-zinc-100 hover:scale-105 transition-all"
                        >
                    ...
                    @if ($mapsUrl)
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            class="inline-flex items-center gap-2 rounded-full bg-white/20 backdrop-blur-md border border-white/30 px-6 py-3.5 text-sm font-bold text-white shadow-md hover:bg-white/30 transition-all"
                        >
