        ...
        <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-12 pb-12 border-b border-zinc-800">
            ...
            <div class="lg:col-span-4 flex flex-col gap-4">
                <div class="flex items-center gap-3">
                    ...
                    @else
                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-primary text-white font-bold text-lg">
            ...
            <div class="lg:col-span-2">
                ...
                <ul class="space-y-2.5 text-xs">
                    ...
                    @if (in_array('menu', $visibleSections, true))
                        <li><a href="#menu" class="hover:text-primary transition-colors">Menu Populer</a></li>
                    @endif
                    ...
                    @if (in_array('reviews', $visibleSections, true))
                        <li><a href="#ulasan" class="hover:text-primary transition-colors">Ulasan Tamu</a></li>
                    @endif
                    @if (in_array('hours', $visibleSections, true) || in_array('location', $visibleSections, true))
                        <li><a href="#lokasi" class="hover:text-primary transition-colors">Jam & Lokasi</a></li>
                    @endif
                </ul>
            </div>
            ...
            <div class="lg:col-span-3 flex flex-col gap-3">
                ...
                @if ($mapsUrl)
                    <a
                        ...
                        class="mt-2 inline-flex items-center justify-center gap-2 rounded-xl bg-primary hover:bg-primary-dark px-4 py-2.5 text-xs font-bold text-white shadow-md transition-all"
                    >
