# Graph Report - WALK-IN-RESTO  (2026-09-21)

## Corpus Check
- 874 files · ~432,764 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9943 nodes · 30488 edges · 435 communities (387 shown, 48 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 2518 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f38e9988`
...
## Communities (435 total, 48 thin omitted)
...
Cohesion: 0.02
Nodes (135): TranslationTabs, BlogAnalytics, ManageBlogHero, BlogHeroFormSchema, BlogCategoryForm, BlogCategoryInfolist, BlogCategoriesTable, BlogCommentForm (+127 more)
...
### Community 50 - "StoreBlogCommentRequest"
Cohesion: 0.24
...
### Community 78 - "Illuminate\Console\Command"
Cohesion: 0.18
...
### Community 109 - "RendersAnalyticsDashboard.php"
Cohesion: 0.11
...
### Community 129 - "Filament/Concerns/HandlesTranslatableForm.php"
Cohesion: 0.38
...
### Community 163 - "Filament\Resources\Pages\CreateRecord"
Cohesion: 0.02
Nodes (54): afterCreate(), afterSave(), ensureAtLeastOneTranslation(), extractTranslations(), hasTranslatableContent(), mutateFormDataBeforeCreate(), mutateFormDataBeforeFill(), mutateFormDataBeforeSave() (+46 more)
...
Cohesion: 0.05
Nodes (6): Dashboard, RestaurantCategory, RestaurantCategorySeeder, RestaurantDirectoryTest, RestaurantRegistrationStepperTest, TenantIsolationTest
...
### Community 173 - "Filament\Widgets\Concerns\InteractsWithPageFilters"
Cohesion: 0.17
...
### Community 183 - "Role"
Cohesion: 0.03
Nodes (17): getRecordRouteBindingEloquentQuery(), AnalyticsKpiWidget, Role, RolePolicy, Spatie\Permission\DefaultTeamResolver, makeOwner(), makeStaff(), AnalyticsChartWidgetRenderTest (+9 more)

### Community 185 - "getDatasetMeta"
Cohesion: 0.11
...
Cohesion: 0.03
Nodes (30): ListBlogCategories, ListBlogComments, ListBloggers, ListBlogPosts, ListBlogTags, ListFacilities, ListLandingTemplates, EditSubscriptionPlan (+22 more)
...
### Community 350 - "addEventListener"
Cohesion: 0.33
...
### Community 361 - "SubscriptionAccess"
Cohesion: 0.04
Nodes (15): canCreate(), canEdit(), canViewAny(), KitchenDisplay, BackedEnum, UnitEnum, Width, OutletResource (+7 more)
...
### Community 415 - "Illuminate\Support\Facades\Schema"
Cohesion: 0.07
...
- **Why does `Restaurant` connect `Restaurant` to `ExportFile`, `TestCase`, `GuestContext`, `Filament\Schemas\Schema`, `PlatformSetting`, `Order`, `Illuminate\Database\Eloquent\Model`, `AdminPanelProvider.php`, `TenantContext`, `CustomerLandingThemeTest`, `Illuminate\Support\Facades\Schema`, `CashierFilamentActionsTest`, `Filament\Resources\Pages\CreateRecord`, `ReceiptLogo`, `Dashboard`, `CommissionReconciliation`, `LandingMenuCatalogTest`, `SoftDeleteTrashTest`, `Filament\Resources\Pages\ListRecords`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Role`, `.count`, `SubscriptionStatus`, `SubscriptionInvoiceResource`, `MenuItem`, `Section`, `FilamentTenantTheme`, `RestaurantReview`, `ExportReportJob.php`, `User`, `Illuminate\Http\Request`, `SubscriptionAccess`, `RegisterRestaurant`, `RendersAnalyticsDashboard.php`, `RestaurantTheme`, `Customer`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `Filament\Widgets\Widget`, `ExportFile`, `TestCase`, `Filament\Schemas\Schema`, `Order`, `Restaurant`, `Illuminate\Database\Eloquent\Model`, `AdminPanelProvider.php`, `TenantContext`, `CashierOrderSoundAlertTest`, `UserFactory`, `CashierFilamentActionsTest`, `Filament\Resources\Pages\CreateRecord`, `Visit`, `Activity`, `Dashboard`, `Filament\Widgets\Concerns\InteractsWithPageFilters`, `CommissionReconciliation`, `AdSetting`, `SoftDeleteTrashTest`, `BlogVisitStatsWidget`, `Filament\Resources\Pages\ListRecords`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Role`, `WhatsappMessage`, `RestaurantReviewApiTest`, `SubscriptionInvoiceResource`, `MenuItem`, `CmsMedia`, `RestaurantReview`, `ExportReportJob.php`, `ManageSoundNotifications`, `Illuminate\Http\Request`, `SubscriptionAccess`, `RegisterRestaurant`, `Customer`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `update()` connect `constructor` to `stat/chart.js`, `code-editor.js`, `rich-editor.js`, `sliceDoc`, `slice`, `advance`, `get`, `fromObject`, `vd`, `y`, `r`, `echo.js`, `resolve`, `facet`, `constructor`, `W`, `reduce`, `Ye`, `markdown-editor.js`, `te`, `next`, `n`, `i`, `.slice`, `replace`, `g$`?**
