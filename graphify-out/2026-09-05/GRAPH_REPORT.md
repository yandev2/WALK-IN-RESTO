...
## Corpus Check
- 633 files · ~300,859 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8542 nodes · 26330 edges · 354 communities (312 shown, 42 thin omitted)
...
## Communities (354 total, 42 thin omitted)
...
Cohesion: 0.02
Nodes (43): CmsBanner, LogOptions, CmsFaq, LogOptions, CmsGalleryImage, CmsProfile, LogOptions, restaurant() (+35 more)
...
Cohesion: 0.03
Nodes (59): ImageOptimizer, BezhanSalleh\FilamentShield\Resources\Roles\Pages\ListRoles, Bityukov\CommandCenter\Filament\Pages\Commands, Bityukov\CommandCenter\Filament\Pages\History, RolePermissionSeeder, Filament\Facades\Filament, Illuminate\Database\QueryException, Illuminate\Foundation\Testing\RefreshDatabase (+51 more)
...
Cohesion: 0.05
Nodes (10): periodSummary(), GuestPay, Payment, PaymentProofService, CashierOrderPreview, CheckoutTotals, CmsMedia, Illuminate\Http\UploadedFile (+2 more)

### Community 9 - "Illuminate\Http\Request"
Cohesion: 0.02
Nodes (71): CartController, CheckoutController, MenuController, OrderController, ReviewController, SessionController, TableController, VisitController (+63 more)
...
### Community 12 - "User"
Cohesion: 0.03
Nodes (28): AnalyticsKpiWidget, Role, LogOptions, User, RolePolicy, UserPolicy, PermissionCheck, Filament\Models\Contracts\FilamentUser (+20 more)

### Community 13 - "Restaurant"
Cohesion: 0.03
Nodes (29): GenerateUpcomingInvoicesCommand, analyticsDateFrom(), analyticsDateTo(), analyticsDayCount(), analyticsRangeLabel(), analyticsSnapshot(), canViewAnalytics(), normalizedAnalyticsDateRange() (+21 more)
...
Cohesion: 0.04
Nodes (15): canCreate(), canEdit(), canViewAny(), ManageCmsProfile, BackedEnum, UnitEnum, OrderResource, ListOrders (+7 more)

### Community 17 - "Order"
Cohesion: 0.03
Nodes (20): PdfExporter, OrderReceiptDownloadController, OrderReceiptPrintController, Order, OrderItem, OrderReceipt, WhatsappMessage, KdsItemService (+12 more)
...
Cohesion: 0.13
Nodes (36): ActivitiesTable, CmsBannerResource, DiningTableResource, KdsStationResource, ModifierGroupResource, TableRightClick, BackedEnum, Carbon\Carbon (+28 more)
...
Cohesion: 0.10
Nodes (32): Filament\Actions\Action, Filament\Forms\Components\ColorPicker, Filament\Forms\Components\Component, Filament\Forms\Components\DatePicker, Filament\Forms\Components\Hidden, Filament\Forms\Components\RichEditor, Filament\Forms\Components\Select, Filament\Forms\Components\Textarea (+24 more)
...
Cohesion: 0.06
Nodes (15): ListFacilities, ListLandingTemplates, CreateSubscriptionInvoice, ListSubscriptionInvoices, ViewSubscriptionInvoice, SubscriptionInvoiceResource, EditSubscriptionPlan, ListSubscriptionPlans (+7 more)
...
Cohesion: 0.03
Nodes (25): SoftDeleteTrashPage, ManageCmsBanners, TrashCmsBanners, CmsFaqResource, ManageCmsFaqs, TrashCmsFaqs, CmsGalleryImageResource, ManageCmsGalleryImages (+17 more)
...
Cohesion: 0.04
Nodes (16): PlatformPageController, RestaurantLandingController, self, PlatformSetting, LandingPageDataService, FilamentTenantTheme, RestaurantTheme, PlatformSettingSeeder (+8 more)
...
Cohesion: 0.06
Nodes (10): Dashboard, GenerateReport, BackedEnum, UnitEnum, ExportFileResource, ListExportFiles, TrashExportFiles, CreateRestaurant (+2 more)
...
### Community 85 - "DiningTable"
Cohesion: 0.03
Nodes (27): DiningTable, LogOptions, Visit, VisitDevice, CashierOrderService, GuestCheckoutService, OrderPaymentService, StaleOperationsService (+19 more)
...
### Community 98 - "static"
Cohesion: 0.03
Nodes (26): canDelete(), canDeleteAny(), canForceDelete(), canRestore(), Action, trashPageAction(), FacilityResource, CreateFacility (+18 more)
...
Cohesion: 0.06
Nodes (8): WelcomeBannerWidget, RestaurantCategory, MenuModifierService, RestaurantDirectory, RestaurantCategorySeeder, Illuminate\Contracts\Pagination\LengthAwarePaginator, Illuminate\Support\Collection, RestaurantDirectoryTest
...
### Community 183 - "ExportReportJob.php"
Cohesion: 0.16
...
### Community 302 - "ManageLandingLayout"
Cohesion: 0.20
...
Cohesion: 0.04
Nodes (15): getRecordRouteBindingEloquentQuery(), bootScopedToRestaurant(), scopeForRestaurant(), scopeWithoutRestaurantScope(), MenuItem, LogOptions, BelongsToRestaurantScope, Illuminate\Database\Eloquent\Builder (+7 more)

### Community 318 - "ManageDiningTables"
Cohesion: 0.24
Nodes (3): ManageDiningTables, Action, Closure
...
Cohesion: 0.08
Nodes (19): BlockGraceMutations, AppServiceProvider, SubscriptionWriteGuard, Filament\Actions\DeleteBulkAction, Filament\Actions\ForceDeleteAction, Filament\Actions\ForceDeleteBulkAction, Filament\Actions\RestoreAction, Filament\Actions\RestoreBulkAction (+11 more)
...
- **Why does `Restaurant` connect `Restaurant` to `Illuminate\Database\Eloquent\Model`, `TestCase`, `Illuminate\Http\Request`, `RegisterRestaurant.php`, `User`, `SubscriptionAccess`, `Order`, `Filament\Tables\Table`, `CreateCashierOrder.php`, `ExportFile`, `Filament\Resources\Pages\ListRecords`, `Filament\Schemas\Schema`, `ManageLandingLayout`, `PlatformSetting`, `ExportReportJob.php`, `SubscriptionStatus`, `MenuItem`, `RendersAnalyticsDashboard.php`, `CashierFilamentActionsTest`, `OrderReceiptPrintTest`, `Dashboard`, `SubscriptionInvoice`, `DiningTable`, `AdminPanelProvider.php`, `ReportExportDispatcher`, `static`, `Illuminate\Support\Collection`?**
