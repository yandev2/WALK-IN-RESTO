                ...
                Section::make('Media Gambar')
                    ...
                    ->schema([
                        FileUpload::make('featured_image')
                            ...
                            ->helperText('Format: JPG, PNG, WEBP. Rasio 16:9 lanskap, otomatis dipotong & dikompres (file awal hingga 15 MB).'),
                        FileUpload::make('og_image')
                            ...
                            ->maxSize(15360)
                            ->acceptedFileTypes(['image/jpeg', 'image/png', 'image/webp'])
                            ->helperText('Format: JPG, PNG, WEBP. Rasio 1200×630 medsos, otomatis dipotong & dikompres (file awal hingga 15 MB).'),
                    ]),
